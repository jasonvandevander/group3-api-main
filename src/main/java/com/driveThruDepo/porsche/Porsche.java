...
public class Porsche {
	...
	public Porsche(String image, String model, String year, String color, double price, String status, double mileage,
	...
	public String toString() {
		return "Porsche [id=" + id + ", image=" + image + ", model=" + model + ", year=" + year + ", color=" + color
