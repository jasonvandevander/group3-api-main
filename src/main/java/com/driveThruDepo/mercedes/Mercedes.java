...
public class Mercedes {
	...
	public Mercedes(String image, String model, String year, String color, double price, String status, double mileage,
	...
	public String toString() {
		return "Mercedes [id=" + id + ", image=" + image + ", model=" + model + ", year=" + year + ", color=" + color
