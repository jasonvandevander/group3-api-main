...
public class Toyota {
	...
	public Toyota(String image, String model, String year, String color, double price, String status, double mileage,
	...
	public String toString() {
		return "Toyota [id=" + id + ", image=" + image + ", model=" + model + ", year=" + year + ", color=" + color
